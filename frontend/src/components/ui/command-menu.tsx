...
/**
 * Keyboard-driven command palette. Registers a global ⌘K / Ctrl+K toggle and
 * Esc to close. Keyboard navigation: arrows, Enter, Home/End.
 */
export function CommandMenu({ commands }: { commands: CommandItem[] }) {
  ...
  // Clamp the selection into range as the result list changes.
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        i === active ? "bg-ink/[0.06] text-ink" : "text-ink-soft",
                      )}
                    >
